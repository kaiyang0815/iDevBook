            ...
            List {
                Section {
                    VStack {
                        ...
                        case .dragGesture:
                            RoundedRectangle(cornerRadius: 12)
                                .offset(
                                    x: dragOffset.width, y: dragOffset.height
                                )
                                .gesture(dragGesture)
                                .shadow(radius: 4)
                                .sensoryFeedback(.success, trigger: tapCount)
                ...
                Section("Control") {
                    ...
                    case .longPressGesture:
                        Stepper {
                            ...
                            minimumDuration += 0.5
                            if minimumDuration >= 10 { minimumDuration = 10 }
                        } onDecrement: {
                            minimumDuration -= 0.5
                            if minimumDuration < 0.5 { minimumDuration = 0.5 }
                        }
                        if showDescription {
                            Text(
                        ...
                        Stepper {
                            ...
                            maximumDistance += 1
                            if maximumDistance >= 20 { maximumDistance = 20 }
                        } onDecrement: {
                            maximumDistance -= 1
                    ...
                    case .dragGesture:
                        Stepper {
                            ...
                            minimumDistance += 1
                            if minimumDistance >= 20 { minimumDistance = 20 }
                        } onDecrement: {
                            minimumDistance -= 1
                ...
                Section("Value") {
                    ...
                    case .spatialTapGesture:
                        LabeledContent(
                            "Tap Count", value: tapCount, format: .number)
                        LabeledContent("Tap Location X", value: location.x, format: .number)
                        LabeledContent("Tap Location Y", value: location.y, format: .number)
                    case .longPressGesture:
                        LabeledContent(
                            "Tap Count", value: tapCount, format: .number)
                    case .dragGesture:
