            ...
            List {
                Section {
                    HStack {
                        ...
                        RoundedRectangle(cornerRadius: largeRadius ? 50 : 12)
                            .fill(.green.gradient)
                    ...
                    if showVS {
                        HStack {
                            ...
                            .fill(.green.gradient)
                            .frame(width: 100, height: 100, alignment: .center)
                            .animation(.default, value: showSpacer2)
                        }
                    }
                } footer: {
                    if showVS {
                ...
                Section {
                    Picker(
                        "Type", selection: $selectedAnimationType.animation()
                    ) {
                        ForEach(AnimationType.allCases, id: \.id) { type in
                ...
                Section("Control") {
                    ...
                    Button("Play") {
                            ...
                            withAnimation(
                                .default
                                    ...
                                    .repeatCount(
                                        ...
                                        autoreverses: animationAutoreverses)
                            ) {
                                showSpacer.toggle()
                                largeRadius.toggle()
                            }
                        ...
                        case .linear:
                            withAnimation(
                                .linear(duration: linearAnimationDuration)
                            ) {
                                showSpacer.toggle()
                                largeRadius.toggle()
                            }
                        case .easeIn:
                            withAnimation(
                                .easeIn(duration: easeInAnimationDuration)
                            ) {
                                showSpacer.toggle()
                                largeRadius.toggle()
                            }
                        case .easeOut:
                            withAnimation(
                                .easeOut(duration: easeOutAnimationDuration)
                            ) {
                                showSpacer.toggle()
                                largeRadius.toggle()
                            }
                        case .easeInOut:
                            withAnimation(
                                .easeInOut(duration: easeInOutAnimationDuration)
                            ) {
                                showSpacer.toggle()
                                largeRadius.toggle()
                            }
                        case .bouncy:
                            withAnimation(
                                .bouncy(
                                    duration: bouncyAnimationDuration,
                        ...
                        case .smooth:
                            withAnimation(
                                .smooth(
                                    duration: smoothAnimationDuration,
                        ...
                        case .snappy:
                            withAnimation(
                                .snappy(
                                    duration: snappyAnimationDuration,
            ...
            .toolbar {
                Menu {
                    ...
                    Toggle(isOn: $showVS.animation()) {
                        Label("Show Other", systemImage: "rectangle.bottomhalf.filled")
                    }
                } label: {
